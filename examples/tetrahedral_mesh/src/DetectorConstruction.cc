...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  // hardcode region attributes, in a real application reading from a database 
  // might be more feasible
  cadmesh::RegionAttributeMap regionAttributeMap;
  regionAttributeMap[1] = {G4Colour::Red(), heartMuscle};
  regionAttributeMap[2] = {G4Colour::White(), adiposeTissue};  
